        ...
        >
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Masters in Data Science</h3>
                <p className="text-sm text-white/60">Prasanna School of Public Health, MAHE</p>
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">BSc in Computer Science & Statistics</h3>
                <p className="text-sm text-white/60">Mahatma Gandhi Memorial College</p>
